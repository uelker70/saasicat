...
export const PUBLIC_CATALOG_BUNDLE_REPOSITORY_TOKEN = Symbol.for('saas-platform/PublicCatalogBundleRepository');
export const PUBLIC_CATALOG_MARKETING_REPOSITORY_TOKEN = Symbol.for('saas-platform/PublicCatalogMarketingRepository');
/**
 ...
 */
export const PUBLIC_CATALOG_CATALOG_ENTRY_REPOSITORY_TOKEN = Symbol.for('saas-platform/PublicCatalogCatalogEntryRepository');
