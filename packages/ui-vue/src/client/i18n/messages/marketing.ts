...
export const marketingMessages = defineMessages(
    {
        ...
        admin: {
            ...
            reorderLabel: '{plan} verschieben · Position {position} von {total}',
            reorderTitle: 'Ziehen oder Pfeiltasten: Reihenfolge ändern',
    ...
    },
    {
        ...
        admin: {
            ...
            colOrder: 'Order',
            colHighlight: 'Highlight',
            reorderLabel: 'Move {plan} · position {position} of {total}',
            reorderTitle: 'Drag or use the arrow keys to reorder',
