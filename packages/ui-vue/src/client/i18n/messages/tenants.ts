...
export const tenantsMessages = defineMessages(
    {
        ...
        charges: {
            title: 'Buchungen',
            holder: 'Konto von {customerNumber} · {legalName}',
            noHolder: 'Für diesen Mandanten ist kein Kunde hinterlegt.',
            ...
            origin: {
                ...
                planChange: 'Planwechsel',
                bundleBooking: 'Zusatzbuchung',
                credit: 'Gutschrift',
    ...
    },
    {
        ...
        charges: {
            title: 'Charges',
            holder: 'Account of {customerNumber} · {legalName}',
            noHolder: 'No customer is on record for this tenant.',
            empty: 'No charges yet.',
            loadFailed: 'The charges could not be loaded.',
            columnDue: 'Due',
            columnPeriod: 'Period',
            columnItem: 'Item',
            columnKind: 'Kind',
            columnOrigin: 'Reason',
            columnAmount: 'Net amount',
            source: {
                plan: 'Plan',
                bundle: 'Add-on',
                discount: 'Discount',
