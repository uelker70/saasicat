// @saasicat/spec — TypeScript definitions for CommonJS consumers.
...
export declare const subscriberLedgerSchema: Record<string, unknown>;
...
export declare const SCHEMAS: {
    ...
    readonly subscriberLedger: Record<string, unknown>;
};
