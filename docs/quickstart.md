...
- German UI by default — the switcher in the header changes it per user, and
  `i18n: { locale: 'en' }` in `main.ts` moves the default
  (see [handbook §8.6](handbook.md#86-ui-language-i18n))
