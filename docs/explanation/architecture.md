...
| `@saasicat/payment-stripe`      | The Stripe side of a gateway account: Checkout in setup mode, and the callback verified with the account's signing secret.                                                        | Backend                       |
